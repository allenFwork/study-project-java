package com.study.exercise.netty.bytebuf;
...
public class ByteBufExamples {
    ...
    public static void byteBufSetGet() {
        ...
        System.out.println("readerIndex = " + buf.readerIndex() + "; writerIndex = " + buf.writerIndex()); // readerIndex = 0; writerIndex = 22
    }
    ...
    public static void writeAndRead() {
        ...
        while (buffer.writableBytes() >= 4) {
            // writeInt(int a) 向buffer中写入了4个字节的数据，buffer.writableBytes()的值减去了4
            buffer.writeInt(i++);
        }
