...
![image-20240105151758073](images\image-20240105151758073.png)

## 2. JVM的功能

![image-20240105152121928](images\image-20240105152121928.png)
...
1. Java语言如果不做任何优化，性能不如C、C++等语言。
   ...
   ![image-20240105152604485](images\image-20240105152604485.png)



2. Java需要实时解释，主要是为了支持跨平台特性。

   ![image-20240105152638585](images\image-20240105152638585.png)



3. 由于JVM需要实时解释虚拟机指令，不做任何优化性能不如直接运行机器码的C、C++等语言。

   ![image-20240105152747478](images\image-20240105152747478.png)



4. JVM提供了<font color=red>即时编译（Just-In-Time 简称JIT) </font>进行性能的优化，最终能达到接近C、C++语言的运行性能甚至在特定场景下实现超越。

   ![image-20240105171019807](images\image-20240105171019807.png)



## 3. 常见的JVM

![image-20240105171203383](images\image-20240105171203383.png)
...
![image-20240105171509487](images\image-20240105171509487.png)
