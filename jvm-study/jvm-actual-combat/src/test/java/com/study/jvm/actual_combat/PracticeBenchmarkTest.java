...
import com.study.jvm.actual_combat.performance.practice.controller.UserController;
...
public class PracticeBenchmarkTest {
    ...
    @Setup
    public void setup() {
        this.context = new SpringApplication(JvmActualCombatApplication.class).run();
