package com.study.springboot.log.aop;
...
@Component
@Aspect   //切面类，此处实现了记录请求信息到数据库的功能
public class SysAspect {

    @Pointcut("@annotation(com.study.springboot.log.annotation.Log)")
    private void pointcut() {

    }

    @Pointcut("execution(* com.study.springboot.log.service.*.*(..))")
